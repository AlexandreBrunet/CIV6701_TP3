...
for idx, csv_file in enumerate(csv_files):
    ...
    travail_df = pivot_df.loc[:, ['NUM_PERS', 'FACPER', 'Travail']]

    occurrences_counts = travail_df.groupby('Travail')['FACPER'].sum().reset_index()
    occurrences_counts.columns = ['Nombre d\'occurrences du déplacement travail', 'Total pondéré']
    ...
    occurrences_counts = occurrences_counts.sort_values('Nombre d\'occurrences du déplacement travail')
