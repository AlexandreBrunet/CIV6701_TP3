...
#regarder seulement les femmes >= 15 ans
sexe_femme = 2
age = 15
...
bar1 = ax.bar(ind - width/2, acces_auto_2003, width, label='2013: Femme > 15 ans')
bar2 = ax.bar(ind + width/2, acces_auto_2013, width, label='2013: Femme > 15 ans')
